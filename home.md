...
## Software
This is a diagram of applications frequently used by Electronics & Mechatronics students.  Many are discovered on-the-fly during projects and these are not provided by your professors.  I am including it here so you can be aware of what past students have found useful.
...
**Diagrams in Drawio (video**
This video introduces draw.io for diagrams.  I consider draw.io as the lightest, simplest tool for arranging technical graphics at the low level.  You can easily export from draw.io into any format and proceed with Visio, Word, or Powerpoint from there.

<iframe width="600" src="https://www.youtube.com/embed/drq9eDgVSfo" title="How to Make Nice Graphics in Draw.io for diagrams" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

# Prototyping

This section relates to modern Manufacturing prototyping methods from 2010+ era which may not appear your coursework.
...
This section covers technical methods for producing prototypes, starting with Bonding. Mechatroncis projects don't discriminate by materials!  By understanding materials, you'll find value in much more than 3D Printing plastic and Metal, and the next step is to discover how to bond these various materials to each other. This topic deserves a whole page for itself, so here we go:
...
Some important Tools in the PIC (009 Thompson hall) and others for serving Undergraduate Education are listed below

| Tool Name | Model   | User Manual | Other Docs   |
| --------- | ------- | ----------- | ------------ |
| Laser Cutter | Universal Laser PLS4.75 | [🔗 User Manual PLS4.75](https://lobfile.com/file/VRu5.pdf) | [🔗 Safety Rules ► refer to LC](https://engineering.tamu.edu/etid/profiles/burnett-douglas.html) |
| Drill Press | Jet Drill Press 2550 | [🔗 User Manual 2550](https://lobfile.com/file/bOsb.pdf) |  [🔗 Safety Rules ► refer to LC](https://engineering.tamu.edu/etid/profiles/burnett-douglas.html) |
...
| Metal 3D Printer | Metal Printer AM400  | [🔗 User Manual 708115K](https://lobfile.com/file/wbTQ.pdf)  | [AM Lab Page](https://engineering.tamu.edu/etid/research/additive-manufacturing-laboratory.html) |
| CNC Waterjet | Globalmax 1508 | [🔗 User Manual 708115K](https://lobfile.com/file/2uGk.pdf)  | [🔗 Safety Rules ► refer to LC](https://engineering.tamu.edu/etid/profiles/smith-christopher.html) |
...
## Example
This is a partial set of documentation for a completed ESET / MXET capstone project
* Capstone Webpage: Access the example [Flobotics Web Page](https://peiyuzhe.wixsite.com/flobotics)
* Design Concept includes the Conceptual Block Diagram, Concept of Operation, Performance Specifications, and Functional Block Diagram
* For the CBD source file, [download Flobotics FBD](https://github.com/dmalawey/mxet/blob/main/flobotic_cbd.drawio) in draw.io format.
**Conceptual Block Diagram**
![conceptual block diagram](https://github.com/MXET/resources/assets/42623372/50bf826a-ee60-4538-a809-8cd5131251c6 ':class=image-25')
...
These are recommended distributors / suppliers for sourcing actions. Consider the suppliers as hubs for knowledge which sometimes steer projects, for better or worse.  We're aiming for sources that meet standards, offer datasheets, post CAD models, and other value-adds which benefit your full project scope.
...
For the above table, this is what is meant by the best choice in a category.
* They are experts at something:  They know more about the product applications than you do.
* They offer documents: Datasheets, CAD, and Brochures that help you choose engineering parts.
* They offer data: actual metrics for the products (tensile strength or power consumption, etc.) and offer filtering.
* They can sort by application: You might not know which polymers are food-safe, for example but you can filter by food-rated, non-conductive, etc.
* Their inventory tracking is SERIOUS.  They supply engineers with time-critical deadlines and they don't mess around like Walmart, cancelling your orders randomly, etc.
* They always have a PART NUMBER. Part number means there's a Brand, or a guarantee the part can be traced 10 years later.



## Glossary

Terms and acronyms found in this website:
...
My position in the ETID department is **Technical Lab Coordinator** and I support students and researchers in the department for lab-based education.
> **David Malawey**
> 
...
_Find more of my published resources & open sourced projects._
...
_when was this repository last updated? See below_
